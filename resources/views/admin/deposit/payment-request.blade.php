            ...
            <div class="container-fluid">
				...
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">Pending Registration Fee</a></li>
					</ol>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Pending Registration Fee</h4>
                            </div>
                            <div class="card-body">
                                       <form action="{{ route('admin.payment-request') }}" method="GET">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-2">
                                                <div class="form-group mb-3">
                                                    <a href="{{ route('admin.payment-request') }}" style="padding: 0.6rem 2rem;"
                                                        name="reset"
                                                        class="btn btn-outline-theme btn-lg d-block w-100 btn-primary"
                                                        value="Reset">Reset</a>
                                                </div>
                                                 ...
                                                 @foreach($deposit_list as $value)
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td ><span class="badge bg-{{ $value->status == 'Active' ? 'success' : 'danger' }}">{{$value->status}}</span></td>
                                                         <td><a href="{{route('admin.payment_request_done')}}?id={{$value->id}}&user_Id={{$value->user_id}}&deposit_status=success" class='btn btn-success'>Success</a> <a href="{{route('admin.payment_request_done')}}?id={{$value->id}}&user_Id={{$value->user_id}}&deposit_status=blocked" class='btn btn-danger'>Reject</a></td>
                                                  </tr>
                                                  @endforeach
