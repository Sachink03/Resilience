...
<td>
    @if($value->withdrawbutton == 0)
        <a href="{{ route('admin.withdraw.toggle', $value->id) }}"
           class="btn btn-success btn-sm"
           onclick="return confirm('Withdraw OFF ?')">
            ON
        </a>
    @else
        <a href="{{ route('admin.withdraw.toggle', $value->id) }}"
           class="btn btn-danger btn-sm"
           onclick="return confirm('Withdraw ON ?')">
            OFF
        </a>
    @endif
</td>
