...
<div class="content-body">
                ...
                <br>
                        ...
                        <div class="card">
                            <div class="card-body d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-inline-block position-relative donut-chart-sale">
                                    ...
                                    <img src="{{ asset('admin/images/streamline.png') }}" style="width: 80px;"
                                        alt="">
                        ...
                        <div class="card">
                            <div class="card-body d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-inline-block position-relative donut-chart-sale">
                                    ...
                                    <img src="{{ asset('admin/images/streamline.png') }}" style="    width: 61px;"
                                        alt="">
                    ...
                    <div class="col-xl-3 col-sm-3">
                        <div class="card">
                            <div class="card-body d-flex align-items-center justify-content-between">
                                <div class="menu">
                                    <span class="font-w500 fs-16 d-block mb-2">Inactive User</span>
                                    <h2>{{ \App\Models\User::where('active_status', 'Inactive')->count() }}</h2>
                                </div>
                                <div class="d-inline-block position-relative donut-chart-sale">
                        ...
                        <div class="card">
                            <div class="card-body d-flex align-items-center justify-content-between">
                                <div class="menu">
                                    ...
                                    <h2>{{ \App\Models\Investment::where('sdate', Date('Y-m-d'))->where('active_from', '!=', 'Deposit Bonus')->where('status', 'Active')->count() }}
                                    </h2>
                                </div>
                                <div class="d-inline-block position-relative donut-chart-sale">

                                    <img src="{{ asset('admin/images/investment.png') }}" style="    width: 61px;"
                                        alt="">
                        ...
                        <div class="card">
                            <div class="card-body d-flex align-items-center justify-content-between">
                                <div class="menu">
                                    ...
                                    <h2>{{ currency() }}
                                        {{ number_format(\App\Models\Investment::where('status', 'Active')->where('active_from', '!=', 'Deposit Bonus')->sum('amount'), 2) }}
                                    </h2>
                                </div>
                                <div class="d-inline-block position-relative donut-chart-sale">


                                    <img src="{{ asset('admin/images/withdrawal.png') }}" style="    width: 61px;"
                                        alt="">
                        ...
                        <div class="card">
                            <div class="card-body d-flex align-items-center justify-content-between">
                                <div class="menu">
                                    ...
                                    <h2> {{ number_format(\App\Models\Investment::where('status', 'Pending')->count(), 2) }}
                                    </h2>
                                </div>
                                <div class="d-inline-block position-relative donut-chart-sale">
                    ...
                    <div class="col-xl-3 col-sm-3">
                        <div class="card">
                            <div class="card-body d-flex align-items-center justify-content-between">
                                <div class="menu">
                                    <span class="font-w500 fs-16 d-block mb-2">Passive Income</span>
                                    <h2>{{ currency() }}
                                        {{ number_format(\App\Models\Income::where('remarks', 'Passive Income')->sum('comm'), 2) }}
                                    </h2>
                                </div>
                                <div class="d-inline-block position-relative donut-chart-sale">

                                    <img src="{{ asset('admin/images/pool_comission.png') }}" style="    width: 61px;"
                                        alt="">
                        ...
                        <div class="card">
                            <div class="card-body d-flex align-items-center justify-content-between">
                                <div class="menu">
                                    ...
                                    <h2>{{ currency() }}
                                        {{ number_format(\App\Models\Income::where('remarks', 'Booster Income')->sum('comm'), 2) }}
                                    </h2>
                                </div>
                                <div class="d-inline-block position-relative donut-chart-sale">
                        ...
                        <div class="card">
                            <div class="card-body d-flex align-items-center justify-content-between">
                                <div class="menu">
                                    ...
                                    <h2>{{ currency() }}
                                        {{ number_format(\App\Models\Income::where('remarks', 'Reward Income')->sum('comm'), 2) }}
                                    </h2>
                                </div>
                                <div class="d-inline-block position-relative donut-chart-sale">
                    ...
                    <div class="col-xl-3 col-sm-3">
                        <div class="card">
                            <div class="card-body d-flex align-items-center justify-content-between">
                                <div class="menu">
                                    <span class="font-w500 fs-16 d-block mb-2">Profit Sharing Income</span>
                                    <h2>{{ currency() }}
                                        {{ number_format(\App\Models\Income::where('remarks', 'Profit Sharing Income')->sum('comm'), 2) }}
                                    </h2>
                                </div>
                                <div class="d-inline-block position-relative donut-chart-sale">

                                    <img src="{{ asset('admin/images/medal.png') }}" style="    width: 61px;"
                                        alt="">
 ...
 --}}
                        ...
                        <div class="card">
                            <div class="card-body d-flex align-items-center justify-content-between">
                                <div class="menu">
                                    ...
                                    <h2>{{ currency() }}
                                        {{ number_format(\App\Models\Withdraw::where('status', 'Pending')->sum('amount'), 2) }}
                                    </h2>
                                </div>
                                <div class="d-inline-block position-relative donut-chart-sale">
                        ...
                        <div class="card">
                            <div class="card-body d-flex align-items-center justify-content-between">
                                <div class="menu">
                                    ...
                                    <h2>{{ currency() }}
                                        {{ number_format(\App\Models\Withdraw::where('status', 'Approved')->sum('amount'), 2) }}
                                    </h2>
                                </div>
                                <div class="d-inline-block position-relative donut-chart-sale">
                ...
                <!--    <a href="https://oceanfunds.live/generate_roi" target="_blank">-->
