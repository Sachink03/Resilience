...
<div id="main-content" class="flex-grow-1 m-3">
    ...
    <div class="mb-4">
        <img
            src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data={{ urlencode($data['qrData']) }}"
            alt="QR Code">
    </div>

    <div class="form-control d-flex align-items-center">
        <span style="flex:1">{{ $data['walletAddress'] }}</span>
        <span onclick="copyWalletAddress()" style="cursor:pointer">
   ...
   <div class="card mt-4" style="background-color: #06080b; ">
                            <div class="card-body text-start p-3">
                                <h5 style="background: linear-gradient(to right, #ffffff, #c979ff, #d6c507, #c1ff28, #b47606, #ff8e01, #ffffff);background-size: 200% auto;-webkit-background-clip: text; background-clip: text;-webkit-text-fill-color: transparent;"
                                    class=" mb-2">Deposit Rules</h5>
                                <ul class="mb-0 ps-3" style="font-size: 0.9rem; color: #ffff;">
                                    ...
                                    <li><strong>Important:</strong> Please select the <strong>BEP20</strong> network
                                        when sending USDT.</li>
                                    <li class="text-danger">Sending funds via any other network may result in permanent
                                        loss of your funds.</li>
                                </ul>
                            </div>
                        </div>
