    ...
    <div class="card">
        ...
        <div class="card-body">
            <p><strong>Available Balance : </strong> $
                {{ number_format(Auth::user()->available_balance(), 2) }}</p>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="walletAddress"
                    value="{{ Auth::user()->usdtBep20 }}" readonly
                    class="form-control">
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <button id="otpButton" type="button" onclick="sendOtp('otpButton')"
                        class="btn btn-secondary"
                        style="background:#11171f;border:1px solid #333;color:white;">
                        Get Code
                    </button>
                </div>
            </div>
...
@endif
    ...
    <script>
        $(function() {
            $('input[name="amount1"]').on('change keyup', function() {
                let str = $(this).val();
                str = str.replace(',', '.');
                $(this).val(str);
                let min = 5;
