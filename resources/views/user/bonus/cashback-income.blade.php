<div id="main-content" class="flex-grow-1 m-3">
    <nav class="navbar navbar-expand-lg sticky-top shadow-sm main-header">
        <div class="container-fluid">
            ...
            <span class="navbar-brand text-capitalize text-white mb-0 h1 d-none d-sm-inline-block"> Booster Income</span>
  ...
  <label class="form-label">Transaction Type</label>
    <select class="form-control" onchange="if(this.value) window.location.href=this.value;">
        ...
        <option style="background-color: #1f1f1f;" value="{{ route('user.Withdraw-History') }}" 
            ...
            {{ Request::routeIs('user.roi-bonus') ? '' : '' }}>Profit Shaing Income</option>
...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <form action="{{ route('user.booster-income') }}" method="GET" class="d-flex ms-auto" style="width: 300px;">
            ...
            <div class="card h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div>
                            <h5 class="mb-1">Booster Income</h5>
