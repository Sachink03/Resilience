<div id="main-content" class="flex-grow-1 m-3">
    <nav class="navbar navbar-expand-lg sticky-top shadow-sm main-header">
        <div class="container-fluid">
           <button class="btn btn-outline-secondary d-md-none me-2" type="button" data-bs-toggle="offcanvas"
            ...
            <span class="navbar-brand text-capitalize text-white mb-0 h1 d-none d-sm-inline-block"> Profit Sharing Income</span>
    ...
    <div class="card mt-3 mb-4">
        ...
        <div class="card-body">
            <form method=post name=opts><input type="hidden" name="form_id" value="17471373813072"><input
                    type="hidden" name="form_token" value="093f914d8d95a4a85b1344f0ce4e2fdb">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" onchange="if(this.value) window.location.href=this.value;">
                                ...
                                <option style="background-color: #1f1f1f;" value="{{ route('user.roi-bonus') }}"
                                    {{ Request::routeIs('user.roi-bonus') ? '' : '' }}>Profit Sharing Income</option>
                                     <option style="background-color: #1f1f1f;" value="{{ route('user.level-income') }}" 
                                {{ Request::routeIs('user.level-income') ? '' : '' }}>Passive Income</option>
 <option style="background-color: #1f1f1f;" value="{{ route('user.booster-income') }}" 
                                {{ Request::routeIs('user.booster-income') ? '' : '' }}>Booster Income</option>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <div>
                                <h5 class="mb-1">Profit Sharing Income</h5>
    ...
    @if ($level_income->lastPage() > 1)
        <div class="pagination justify-content-center mt-4">
            <ul class="pagination">
                ...
                {{-- Next Page Link --}}
                <li
                    class="page-item {{ $level_income->currentPage() == $level_income->lastPage() ? 'disabled' : '' }}">
