...
<head>
    <meta charset="utf-8" />
    <title>Recover Password - Unique World Funds</title>
...
<body class="body color-left">
    ...
    <div class="section" style="background: url('images/rd_1.png') no-repeat center center/cover; 
        ...
        <div class="container w-password-page w-form">
            <form action="{{route('forgot_submit')}}" method="post" id="email-form" name="email-form"
                ...
                <div class="password-text-wrap">
                    <h1 class="h3 mobile-text-center">Recover Access</h1>
                ...
                <div class="password-bottom">
                        ...
                        <input class="text-field password w-password-page w-input" maxlength="256" name="email"
                            placeholder="Enter your registered email" type="text" id="forget_email" required />
                    </div>
                    ...
                    <div style="padding-top: 15px; text-align: center; font-size: 14px;">
                        ...
                        <a href="register" style="text-decoration: none; color: #00ff8f">Sign up</a>
                    </div>
                </div>
            </form>
        </div>
