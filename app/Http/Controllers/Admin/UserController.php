...
public function withdrawToggle($id)
{
    $user = User::findOrFail($id);

    // toggle logic
    $user->withdrawbutton = ($user->withdrawbutton == 0) ? 1 : 0;
    $user->save();
                  ...
                  if ($users->active_status=="Pending")
                   {
                    ...
                    $user_update=array('active_status'=>'Active','adate'=>Date("Y-m-d H:i:s"),'package'=>$request->amount,'booster_adate'=>Date("Y-m-d H:i:s"));
