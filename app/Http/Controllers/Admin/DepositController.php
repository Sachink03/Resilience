...
public function payment_request(Request $request)
    {
        ...
        $notes = Payment::where('status','pending')->orderBy('id', 'DESC');
    ...
    $notes = $notes->paginate($limit)
        ...
        $this->data['page'] = 'admin.deposit.payment-request';
...
public function deposit_request(Request $request)
    ...
    $notes = $notes->paginate($limit)
        ...
        $this->data['deposit_list'] =  $notes;
        $this->data['search'] = $search;
        $this->data['page'] = 'admin.deposit.payment-list';
        return $this->admin_dashboard();
    }
   ...
   public function payment_request_done(Request $request)
    {
     ...
     if ($deposit_status=="success")
      {
           ...
           Payment::where('id',$id)->update($update_data); 
           
          $user_update=array('active_status'=>'Active','adate'=>Date("Y-m-d H:i:s"));
          User::where('id',$user->user_id)->update($user_update);
